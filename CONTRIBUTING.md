...
acquainted with the community, review the [README file](README.md), and view the [source code](https://GitHub.com/fluid-project/sjrk-story-telling-server).
...
The SJRK Storytelling Tool Server [source code](https://github.com/fluid-project/sjrk-story-telling-server) is hosted on GitHub. All of the code that is included in a release lives in the master branch.
...
The SJRK Storytelling Tool Server uses a workflow where contributors fork the project repository, work in a branch created off of master, and submit a pull request against the project repo's master branch to merge their contributions.
...
The SJRK Storytelling Tool Server uses a [JIRA](https://issues.fluidproject.org) issue tracker. All work should be associated with a
...
```bash
# Runs the SJRK Storytelling Tool Server's linting tasks
grunt lint
```
