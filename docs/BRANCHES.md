...
each of which has a specific purpose, such as being used to deploy particular versions of the site. The `main` branch
...
| ----------------------------------- | ---- | ----------- |
| `main`                            | [The Storytelling Project staging site](https://staging-stories.floeproject.org/) | Stories on this site are cleared every 24 hours, it is intended purely as a sandbox demonstration of the Storytelling Tool |
